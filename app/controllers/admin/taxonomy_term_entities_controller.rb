class Admin::TaxonomyTermEntitiesController < Admin::AdminController
  # GET /entity_terms
  # GET /entity_terms.json
  def index
    @entity_terms = TaxonomyTermEntity.all
  ...
  def show
    @entity_term = TaxonomyTermEntity.find(params[:id])
  ...
  def new
    @entity_term = TaxonomyTermEntity.new
  ...
  def create
    @entity_term = TaxonomyTermEntity.new(params[:entity_term])
